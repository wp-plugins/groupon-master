...
class groupon_master_admin_addons_table extends WP_List_Table {
	 ...
	 */
	function display() {
	$path = ABSPATH . 'wp-content/plugins/groupon-master-addons/';
	if ( is_plugin_active( 'groupon-master-addons/groupon-master-addons.php' ) && file_exists($path) ) {
		$groupon_master_addon = "yes";
		$groupon_master_addon_get = '<b>All add-ons Installed</b>';
	}
	else{
		$groupon_master_addon = "no";
		$groupon_master_addon_get = '<a class="button-primary" href="http://wordpress.techgasp.com/groupon-master/" target="_blank" title="Get Add-ons" style="float:left;">Get Add-ons</a>';
	}
?>
<table class="widefat fixed" cellspacing="0">
	<thead>
		<tr>
			...
			<th id="columnname" class="manage-column column-columnname" scope="col"><h3><img src="<?php echo plugins_url('images/techgasp-minilogo-16.png', dirname(__FILE__)); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;Installed', 'groupon_master'); ?></h3></legend></th>
		</tr>
	</thead>

	<tfoot>
		<tr>
			<th class="manage-column column-columnname" scope="col" width="300"><?php echo $groupon_master_addon_get; ?></th>
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-grouponmaster-admin-addons-widget-buttons.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('groupon_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			...
			<td class="column-columnname" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-yes.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('groupon_master_name'); ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-grouponmaster-admin-addons-widget-groupon-deals.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('groupon_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-grouponmaster-admin-addons-shortcode-in.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('groupon_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			...
			<td class="column-columnname" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-'.$groupon_master_addon.'.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('groupon_master_name'); ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-grouponmaster-admin-addons-shortcode-un.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('groupon_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-grouponmaster-admin-addons-updater.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('groupon_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-grouponmaster-admin-addons-support.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('groupon_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
