...
<table class="widefat fixed" cellspacing="0">
	<thead>
		<tr>
			<th id="columnname" class="manage-column column-columnname" scope="col" width="387"><legend><h3><img src="<?php echo plugins_url('../images/techgasp-minilogo-16.png', __FILE__); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;About', 'groupon_master'); ?></h3></legend></th>
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="387"><img src="<?php echo plugins_url('../images/techgasp-grouponmaster-logo.png', __FILE__); ?>" alt="<?php echo get_option('groupon_master_name'); ?>" align="left" width="387px" height="171px" style="padding:5px;"/></td>
