...
<tr>
<td width="387">
<img src="<?php echo plugins_url('../images/techgasp-grouponmaster-logo.png', __FILE__); ?>" alt="Groupon Master" align="left" width="387px" height="171px" style="padding:5px;"/>
</td>
<td width="0,5"></td>
<td width="700">
...
<h2><?php _e("Groupon Master LITE Version", 'groupon_master'); ?></h2>
<br>
<form method="post" width='1'>
<fieldset class="options">
<legend><h3><img src="<?php echo plugins_url('../images/techgasp-minilogo-16.png', __FILE__); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;Advanced Version Updater:', 'groupon_master'); ?></h3></legend>
<br>
<div class="description">Only available in <b>Groupon Master Advanced Version</b>.</div>
</fieldset>
<p class="submit"><input class='button-primary' type='submit' name='update' value='<?php _e("Save Settings", 'groupon_master'); ?>' id='submitbutton' /></p>
...
<div class="description">All widget options are available in your widgets page. <b>Groupon Master Widget</b>.</div>
...
<div class="description">The shortcode framework allows you to insert Groupon Master inside Pages & Posts without the need of extra plugins or gimmicks. Fast page load times and top SEO. Only available in <b>Groupon Master Advanced Version</b>.</div>
<br>
<div style="background: url(<?php echo plugins_url('../images/techgasp-hr.png', __FILE__); ?>) repeat-x; height: 10px"></div>

<h3><img src="<?php echo plugins_url('../images/techgasp-minilogo.png', __FILE__); ?>" style="width:40px; vertical-align:middle;" alt="' . esc_attr__( 'TechGasp Plugins') . '" /> Groupon Master Website</h3>
<p><a class="button-secondary" href="http://wordpress.techgasp.com/groupon-master/" target="_blank" title="Groupon Master Info Page">Info Page</a> <a class="button-secondary" href="http://wordpress.techgasp.com/groupon-master-documentation/" target="_blank" title="Groupon Master Documentation">Documentation</a> <a class="button-primary" href="http://wordpress.techgasp.com/groupon-master/" target="_blank" title="Groupon Master Advanced Version">Advanced Version</a></p>
</form>
</div>