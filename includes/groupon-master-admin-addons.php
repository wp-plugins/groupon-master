<?php
if( is_multisite() ) {
	function menu_multi_groupon_admin_addons(){
	// Create menu
...
<h2><b>&nbsp;<?php echo get_option('groupon_master_name'); ?> Add-ons</b></h2>
<?php
...
if( is_multisite() ) {
add_action( 'network_admin_menu', 'menu_multi_groupon_admin_addons' );
}
else {
